...
import PisosAgent from './components/PisosAgent.jsx';
      ...
      <div className="container mx-auto p-4">
        ...
        <Tabs defaultValue="chat" className="w-full">
          <TabsList className="grid w-full grid-cols-11">
            ...
            <TabsTrigger value="pisos" className="flex items-center gap-2">
              🏠
              Pisos
            </TabsTrigger>
          ...
          <TabsContent value="pisos" className="space-y-4">
            <PisosAgent apiUrl="http://localhost:5000" />
          </TabsContent>

          <TabsContent value="orchestrator" className="space-y-4">
            <OrchestratorPanel apiUrl="http://localhost:5000" />
          </TabsContent>

          <TabsContent value="reviewer" className="space-y-4">
            <ReviewerPanel apiUrl="http://localhost:5000" />
          </TabsContent>
